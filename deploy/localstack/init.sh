...
redrive=$(printf '{"VisibilityTimeout":"30","RedrivePolicy":"{\"deadLetterTargetArn\":\"%s\",\"maxReceiveCount\":\"5\"}"}' "$dlq_arn")
awslocal sqs set-queue-attributes --queue-url http://localhost:4566/000000000000/wager-transactions.fifo --attributes "$redrive"
